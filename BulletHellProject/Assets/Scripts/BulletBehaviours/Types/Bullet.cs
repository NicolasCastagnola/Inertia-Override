...
public abstract class Bullet : Prototype, IPoolable<Bullet>
{
    ...
    public Bullet SetBehaviour(BulletBeahaviour beahaviour)
    {
        if (_target)
        {
            switch (beahaviour)
            {
                case BulletBeahaviour.None:
                    currentBehaviour = new NoneBulletBehaviour();
                    break;
                case BulletBeahaviour.Homing:
                    currentBehaviour = new Homing(transform, _target, _speed);
                    break;
                case BulletBeahaviour.Triangulate:
                    break;
                default:
                    break;
            }
